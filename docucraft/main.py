...
The module handles the entire workflow, including data loading, transformation, and document generation.
...
def main() -> None:
    ...
    df_to_dict = {cfg.OUTPUT_DIR_DOCX / f"{key}.docx": dict(value) for key, value in df_to_dict.items()}

    create_documents(cfg.PATH_TO_DOCX_TPL, df_to_dict)
